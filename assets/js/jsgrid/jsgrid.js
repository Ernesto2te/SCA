(function($) {
    ...
    $("#basicScenario").jsGrid({
        ...
        controller: db,
        fields: [ 
            { name: "No", type: "html", width: 200 },
            { name: "Apellido Paterno", type: "html", width: 200 },
            { name: "Apellido Materno", type: "html", width: 200 },
            { name: "Nombre(s)", type: "html", width: 150 },
            { name: "Matricula", type: "html", width: 150 },
            { name: "Valoracion Numerica", type: "text", width: 200 },
            { name: "Observaciones", type: "text", width: 200, },
            { name: "Nivel Desempeño", type: "text", width: 200 },
            { name: "Tipo De Curso", type: "html", width: 200 },
